...
class fskDemodulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fskDemodulation")
        ...
        # Variables
        ##################################################
        self.transition_bw = transition_bw = 10
        self.samp_rate = samp_rate = 200
        self.noise = noise = 0
        self.fsk_deviation = fsk_deviation = 0
        self.frequency2 = frequency2 = 60
        self.frequency1 = frequency1 = 20
        self.cutoff_frequency = cutoff_frequency = 30

        ##################################################
        # Blocks
        ##################################################
        self._noise_range = Range(0, 1, 0.001, 0, 200)
...
def main(top_block_cls=fskDemodulation, options=None):
